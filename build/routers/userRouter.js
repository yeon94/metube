...
userRouter.get(_routes["default"].editPassword, _middlewares.onlyPrivate, _userController.getEditPassword);
userRouter.post(_routes["default"].editPassword, _middlewares.onlyPrivate, _userController.postEditPassword);
